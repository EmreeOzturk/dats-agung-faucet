...
const Aurora = () => {
    ...
    const [state, setState] = useState<ResponseType>(initialResponse);
        ...
        >
            <div className="relative z-10 flex flex-col items-center">
                <span className="mb-1.5 inline-block rounded-full bg-gray-600/50 px-3 py-1.5 text-sm">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-violet-400">
                        DATSProject
                    </span> 🚀
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-sky-500">
                        Peaq Network
                    </span>
                </span>
                <h1 className="max-w-5xl bg-gradient-to-br from-white to-gray-400 bg-clip-text text-center text-3xl font-medium leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight">
                    Obtain AGUNG Testnet tokens every 12 hours for seamless and confident testnet.
                </h1>
                <form
